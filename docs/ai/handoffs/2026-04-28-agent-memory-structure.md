...
- What was requested: Implement a lightweight Markdown memory structure for Cursor/Codex agents and subagents, then add simple agent role, workflow, and current-state docs.
- Final outcome: Added repo-level agent instructions, AI memory docs, coordination docs, templates, a local development runbook, and an initial decision record.
